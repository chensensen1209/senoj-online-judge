...
(
    ...
    tags        varchar(1024)                      null comment '标签列表（json 数组字符串）',
    answer      text                               null comment '题目答案',
    submitNum   int      default 0                 not null comment '提目提交次数',
    acceptedNum int      default 0                 not null comment '提目ac次数',
...
(
    ...
    status     int      default 0                 not null comment '判题状态 0默认 1判题 2成功 3失败',
